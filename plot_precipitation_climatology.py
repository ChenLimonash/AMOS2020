...
if __name__ == '__main__':
    ...
    parser.add_argument("season", type=str,choices=["DJF","MAM","JJA","MAM"],help="Season to plot")
    parser.add_argument("output_file", type=str, help="Output file name")
    parser.add_argument("--gridlines",action="store_true",default=False,help="draw gridlines")
